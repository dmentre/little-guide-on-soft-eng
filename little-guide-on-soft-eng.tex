...
\item[\Rule{} Use meaningful names]
 ...
 its context or internals.\cite[sec 1.1]{kernighan99}
...
\item[\Rule{} Test or prove thoroughly your code]
  ...
  Mathematically prove the correctness of the most critical parts, no
  bug should be allowed to slip in them.
...
\item[\Rule{} Be DRY: Don't Repeat Yourself]
  ...
  any piece of data, preferably in text form.\cite[sec 7]{andrew99}
